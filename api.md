...
- <code title="get /api/{serviceId}/service/configuration">client.service.get.<a href="./src/resources/service/get.ts">getConfiguration</a>(serviceID, { ...params }) -> unknown</code>
...
- <code title="delete /api/{serviceId}/client/authorization/delete/{clientId}">client.client.authorization.<a href="./src/resources/client/authorization/authorization.ts">delete</a>(clientID, { ...params }) -> AuthorizationDeleteResponse</code>
...
- <code title="post /api/{serviceId}/client/registration/get">client.client.registration.<a href="./src/resources/client/registration.ts">retrieve</a>(serviceID, { ...params }) -> RegistrationRetrieveResponse</code>
...
- <code title="get /api/{serviceId}/auth/authorization/ticket/info">client.auth.authorization.ticket.<a href="./src/resources/auth/authorization/ticket.ts">info</a>(serviceID) -> TicketInfoResponse</code>
...
- <code><a href="./src/resources/gm.ts">GmProcessGrantManagementRequestResponse</a></code>

Methods:

- <code title="post /api/{serviceId}/gm">client.gm.<a href="./src/resources/gm.ts">processGrantManagementRequest</a>(serviceID, { ...params }) -> GmProcessGrantManagementRequestResponse</code>
...
- <code><a href="./src/resources/backchannel/authentication.ts">AuthenticationCompleteProcessResponse</a></code>
...
- <code title="post /api/{serviceId}/backchannel/authentication/complete">client.backchannel.authentication.<a href="./src/resources/backchannel/authentication.ts">completeProcess</a>(serviceID, { ...params }) -> AuthenticationCompleteProcessResponse</code>
...
- <code><a href="./src/resources/vci/offer.ts">OfferInfoResponse</a></code>
...
- <code title="post /api/{serviceId}/vci/offer/info">client.vci.offer.<a href="./src/resources/vci/offer.ts">info</a>(serviceID, { ...params }) -> OfferInfoResponse</code>
