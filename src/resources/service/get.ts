...
export class Get extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.service.get.getConfiguration(
   *   'serviceId',
   * );
   * ```
   */
  getConfiguration(
    serviceID: string,
    query: GetGetConfigurationParams | null | undefined = {},
 ...
 * for more details.
 */
export type GetGetConfigurationResponse = unknown;
...
export interface GetGetConfigurationParams {
  /**
   * Get the JSON Patch
...
export declare namespace Get {
  export {
    ...
    type GetGetConfigurationParams as GetGetConfigurationParams,
