...
export class Offer extends APIResource {
   ...
   */
  info(serviceID: string, body: OfferInfoParams, options?: RequestOptions): APIPromise<OfferInfoResponse> {
...
export interface OfferInfoParams {
  /**
...
export declare namespace Offer {
  export {
    ...
    type OfferInfoResponse as OfferInfoResponse,
    type OfferCreateParams as OfferCreateParams,
    type OfferInfoParams as OfferInfoParams,
  };
}
