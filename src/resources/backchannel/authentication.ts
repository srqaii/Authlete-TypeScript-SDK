...
export class Authentication extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.backchannel.authentication.completeProcess(
   *     'serviceId',
   *     {
   *       result: 'AUTHORIZED',
   *       subject: 'john',
  ...
  completeProcess(
    serviceID: string,
    body: AuthenticationCompleteProcessParams,
    options?: RequestOptions,
  ): APIPromise<AuthenticationCompleteProcessResponse> {
...
export interface AuthenticationCompleteProcessResponse {
  /**
...
export interface AuthenticationProcessResponse {
  ...
  grant?: AuthenticationProcessResponse.Grant;
...
export namespace AuthenticationProcessResponse {
...
export interface AuthenticationCompleteProcessParams {
  /**
